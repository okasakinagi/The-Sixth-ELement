...
> 版本说明：本文件是早期补全工作的阶段总结（历史快照），其中“13 个已实现、18 个待实现”等统计已过期。
> 当前准确口径请以 `doc/api/API-总览.md` 与 `doc/api/readme.md` 为准。
...
### 1. 全面性
- ✅ 覆盖已实现的全部 13 个接口
- ✅ 历史上标注的 18 个扩展接口已在文档中明确为兼容/扩展口径
